...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	Site Details
        ...
        <link href="https://feeder.terradex.com/templates/css/style.css" rel="stylesheet" type="text/css" />
        <link href="https://feeder.terradex.com/templates/css/infowindow-style.css" rel="stylesheet" type="text/css" />
        <link type="text/css" href="https://feeder.terradex.com/templates/js/jquery/themes/smoothness/jquery-ui-1.8.9.custom.css" rel="stylesheet" />
        <script type="text/javascript" src="https://feeder.terradex.com/templates/js/jquery/jquery-1.5.min.js"></script>
        <script type="text/javascript" src="https://feeder.terradex.com/templates/js/jquery/ui/jquery-ui-1.8.9.custom.js"></script>
...
<!--                                    <b>Details and Monitoring Report </b>-->
  ...
  <div class="section-title excavation">Site Details and Monitoring Report</div>
        <div id="tabs">
            <ul>
               ...
               { ?>      <li><a href="#tabs-one">Property</a></li>
               <?php } else {echo'';} ?>

                <li><a href="#tabs-two">Site</a></li>
                <li><a href="#tabs-three">Monitoring</a></li>

              <?php if (strtolower($PayingParty_short)=='demo')
               { ?>      <li><a href="#tabs-four">Investigation</a></li>
              <?php } else {echo'';} ?>



               <?php if (isset( $listed_docs['0']['DocID']))
                { ?>      <li><a href="#tabs-five">Documents</a></li>
               <?php } else {echo'';} ?>

                <li><a href="#tabs-six">Users</a></li>
            </ul>

<!--  Below are the Details for Each Tab-->
  <?php if (strtolower($PayingParty_short)=='demo'){ ?>  
<div id="tabs-one">
